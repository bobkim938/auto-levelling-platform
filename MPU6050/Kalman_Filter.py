...
class KalmanFilter:
    def __init__(self):
        ...
        self.P = np.array([[0.0, 0.0], [0.0, 0.0]])  # priori covariance matrix
    ...
    def get_angle(self, angle_new, gyro_rate, dt):
        ...
        # Calculate difference between actual measurement and predicted measurement based on the current state estimate
