...
def main():
    ...
    try:
        while True:
            ...
            if not balance_roll:
                if roll > 0:
                    if pos2[2] >= (127 * np.tan(roll * np.pi / 180)) and pos3[2] >= (
                        ...
                        while not balance_roll:
                            ...
                            if roll == 0:
                                ...
                                motor2.throttle = 0
                                motor3.throttle = 0
                                pos2[2] -= 127 * np.tan(temp_x * np.pi / 180)
                                pos3[2] -= 127 * np.tan(temp_x * np.pi / 180)
                                counter = 0
                        ...
                        while not balance_roll:
                            ...
                            if roll == 0:
                                ...
                                motor2.throttle = 0
                                motor3.throttle = 0
                                pos1[2] += 127 * np.tan(temp_x * np.pi / 180)
                                counter = 0
                                print("pos1: ", pos1[2], " pos2: ", pos2[2], " pos3: ", pos3[2])
                                break
                elif roll < 0:
                ...
                if not balance_pitch:
                    if pitch > 0:
                        if pos2[2] >= (110 * np.tan(pitch * np.pi / 180)):
                            while not balance_pitch:
                                ...
                                if pitch == 0:
                                    ...
                                    motor2.throttle = 0
                                    motor3.throttle = 0
                                    pos2[2] -= 110 * np.tan(temp_y * np.pi / 180)
                                    counter = 0
                                    print("pos1: ", pos1[2], " pos2: ", pos2[2], " pos3: ", pos3[2])
                                    break
                        else:
                            while not balance_pitch:
                                ...
                                if pitch == 0:
                                    ...
                                    motor2.throttle = 0
                                    motor3.throttle = 0
                                    pos3[2] += 110 * np.tan(temp_y * np.pi / 180)
                                    counter = 0
                                    print("pos1: ", pos1[2], " pos2: ", pos2[2], " pos3: ", pos3[2])
                                    break
